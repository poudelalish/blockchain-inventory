...
export default function AddMed() {
  ...
  const handlerChangeDescriptionProduct = (event: any) => {
    ...
    try {
      ...
      if (errorMessage.includes('revert') || errorMessage.includes('require')) {
        if (errorMessage.includes('Owner')) {
          ...
          errorMessage = 'Please register at least one role of each type (RMS, Manufacturer, Distributor, Retailer) before adding products.'
        } else {
