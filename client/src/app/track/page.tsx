...
export default function Track() {
  ...
  const loadBlockchainData = async () => {
    try {
      ...
      for (let i = 0; i < medCtr; i++) {
        ...
        productStageData[productId] = await contract.methods.showStage(productId).call()
  ...
  const trackProduct = async (productId: number) => {
    try {
      ...
      const stage = parseInt(product[productId].stage)
  ...
  const TrackComponent = ({
    ...
    const productData = {
      ...
      currentStage: productStage[productId],
    }
        ...
        <div className="bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl shadow-2xl p-8 mb-8 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              ...
              <div className="text-lg font-semibold">{productStage[productId]}</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-3">
            ...
            <div className="rounded-lg bg-green-50 p-3">
              ...
              <div className="text-xs text-gray-700 mt-1">{formatUnixTimestamp(productTimestamps[productId]?.rawSupplyAt)}</div>
            </div>
            ...
            <div className="rounded-lg bg-purple-50 p-3">
              ...
              <div className="text-xs text-gray-700 mt-1">{formatUnixTimestamp(productTimestamps[productId]?.distributionAt)}</div>
            </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 p-5">
        <TrackComponent
          ...
          stages={[
            {
              label: 'Raw Products Supplied by',
              data: rms[parseInt(product[productId]?.RMSid)],
              showArrow: true,
              icon: stageIcons.rms,
            },
            {
            ...
            },
            {
              ...
              data: dis[parseInt(product[productId]?.DISid)],
              showArrow: true,
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                  ...
                  {Object.keys(product).map((key) => {
                    ...
                    const stage = productStage[productId]
